...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        body: ReponsiveHomePage(),
      )
    );
  }
}
class ReponsiveHomePage extends StatelessWidget {
  @override
  
  static const colorCodes = (
    body: Color(0xFFF8E287),
    navigation: Color(0xFFc5ecc2),
  ...
  Widget buildCompactScreen() {
    return Column(
      children: [
        ...
        Container(
          height: 80, color: colorCodes.navigation, child: navigation ,
        )
      ],
    );
  }
  Widget buildMediumScreen() {
    return Row(
      children: [
        Container(
          width: 80, color: colorCodes.navigation,
        ),
        Expanded(child: Container(color: colorCodes.body, child: body)),
    ...
    return Row(
      children: [
        Container(
         ...
         Container(
          width: 360, color: colorCodes.body, child: body,
        ),
        Expanded(child: Container(color: colorCodes.pane, child: pane)),
   ...
   Widget buildLargeScreen() {
    return Row(
      children: [
        Container(
          width: 360, color: colorCodes.navigation, child: navigation,
        ),
         Container(
          width: 360, color: colorCodes.body, child: body,
        ),
